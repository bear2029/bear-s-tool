		...
		<form className="crawler-editor" onSubmit={this.onSubmit}>
			<div className="editor">
				...
				<div className={collectionUrlSectionClass}>
					<input name="collection-url" onKeyUp={this.onUrlMatchChanged} type="url" className="form-control wide" placeholder="list URL for test" value={this.state.collectionUrl}/>
					<div className="validation-icon"><span className="glyphicon glyphicon-ok" aria-hidden="true"></span></div>
					<input type="text" onKeyUp={this.onUrlMatchChanged} className="form-control" name="collection-url-regex" placeholder="list URL regex" value={this.state.collectionUrlRegex} />
				</div>
			...
			<div className={consoleClassName}>
				<h4>Console</h4>
				<textarea readOnly className="form-control" value={this.state.consoleHtml}></textarea>
			</div>
		</form>
		</div>
		);
